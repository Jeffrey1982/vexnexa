...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-base font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        primary: "bg-primary text-primary-foreground hover:bg-primary-600 active:bg-primary-700 shadow-soft-sm hover:shadow-soft-md",
        secondary: "bg-charcoal text-white hover:bg-charcoal-dark shadow-soft-sm hover:shadow-soft-md",
        ghost: "border-2 border-charcoal text-charcoal hover:bg-charcoal hover:text-white",
        link: "text-primary underline-offset-4 hover:underline",
        outline: "border border-steel-300 bg-transparent hover:bg-steel-50",
      },
      size: {
