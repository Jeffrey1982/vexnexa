                                ...
                                {!isEditing && (
                                  <div className="flex items-center gap-2">
                                    <button
                                      ...
                                      disabled={isSaving}
                                      className="p-2 hover:bg-green-100 rounded transition-colors disabled:bg-[var(--vn-disabled-bg)] disabled:text-[var(--vn-disabled-fg)] disabled:opacity-100"
                                      title="Pass"
                                    >
                                    ...
                                    <button
                                      ...
                                      disabled={isSaving}
                                      className="p-2 hover:bg-red-100 rounded transition-colors disabled:bg-[var(--vn-disabled-bg)] disabled:text-[var(--vn-disabled-fg)] disabled:opacity-100"
                                      title="Fail"
                                    >
                                    ...
                                    <button
                                      ...
                                      disabled={isSaving}
                                      className="px-3 py-1 text-sm text-blue-600 hover:bg-blue-50 rounded transition-colors disabled:bg-[var(--vn-disabled-bg)] disabled:text-[var(--vn-disabled-fg)] disabled:opacity-100"
                                    >
                                      Details
                                    </button>
                                  </div>
                                      ...
                                      <div className="border-t border-gray-200 pt-4 space-y-4">
                                        ...
                                        <div className="flex gap-2">
                                          <button
                                            ...
                                            className="flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:bg-[var(--vn-disabled-bg)] disabled:text-[var(--vn-disabled-fg)] disabled:opacity-100 disabled:cursor-not-allowed"
                                          >
                                            {isSaving ? (
                                              <>
