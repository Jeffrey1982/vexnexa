    ...
    >
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl rounded-3xl border border-white/10 bg-gradient-to-b from-white/[0.04] to-white/[0.01] p-8 text-center shadow-2xl sm:p-10">
          ...
          {/* VAT toggle */}
          <div
            className="mt-7 inline-flex items-center gap-1 rounded-full border border-white/15 bg-white/[0.04] p-1"
            role="tablist"
          ...
          <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:justify-center">
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="h-12 rounded-xl border-white/20 bg-white/[0.04] px-7 font-semibold text-white hover:bg-white/[0.08]"
            >
              <Link
