  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl rounded-3xl border border-border bg-gradient-to-b from-slate-50 to-white dark:from-white/[0.04] dark:to-white/[0.01] p-8 text-center shadow-2xl sm:p-10">
          ...
          {/* VAT toggle */}
          <div
            className="mt-7 inline-flex items-center gap-1 rounded-full border border-border dark:border-white/15 bg-muted dark:bg-white/[0.04] p-1"
            role="tablist"
          ...
          {/* What's included */}
          <ul className="mx-auto mt-7 grid max-w-md gap-2 text-left text-sm text-muted-foreground sm:grid-cols-2">
          ...
          <div className="mt-8 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:justify-center">
            ...
            <Button
              ...
              variant="outline"
              asChild
              className="h-12 rounded-xl border-border dark:border-white/20 bg-muted dark:bg-white/[0.04] px-7 font-semibold text-foreground hover:bg-white/[0.08]"
            >
              <Link
