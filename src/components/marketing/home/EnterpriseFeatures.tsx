 ...
 *   B. Historical Compliance Tracking — proof of progress per client site
 *   C. Client Portfolio Dashboard — all client sites in one view
 *
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        {/* Report preview — HTML mock with the same realistic mid-range data
            as the hero (72/100); links to the sample report. */}
        <figure className="mt-14 overflow-hidden rounded-2xl border border-border bg-card shadow-soft-md">
          <Link
            href="/sample-report"
            className="block transition-transform duration-500 hover:scale-[1.005]"
