  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        ...
        {/* Product screenshot — cropped to the report header so it reads as a
            preview instead of a full-page scroll wall; links to the sample report. */}
        <figure className="mt-14 overflow-hidden rounded-2xl border border-border bg-card shadow-soft-md">
          <Link
            href="/sample-report"
            className="block max-h-[420px] overflow-hidden sm:max-h-[520px]"
            aria-label={t("screenshotCaption")}
          >
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/Screenshot1.png"
              alt="VexNexa Accessibility Compliance Report cover page for vexnexa.com — WCAG 2.2 AA standard, scan completed 7 May 2026, zero critical, serious, moderate, and minor issues across 10 pages, Enhanced Accessibility Score 100/100, VNI Rank 1912 of 2500 with an Authority four-star rating, generated by axe-core."
              className="h-auto w-full object-cover object-top transition-transform duration-500 hover:scale-[1.01]"
              width={1600}
              height={2070}
              loading="lazy"
              decoding="async"
