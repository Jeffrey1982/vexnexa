...
export function EnterpriseConversionPanel() {
  ...
  return (
    <section className="relative bg-background py-20 sm:py-24" aria-labelledby="enterprise-conversion-heading">
          ...
          <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch">
            ...
            <article className="flex h-full flex-col rounded-2xl border border-border bg-gradient-to-br from-white to-slate-50 p-6 text-center shadow-xl dark:border-white/10 dark:from-white/[0.04] dark:to-white/[0.01] sm:p-7">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:justify-center">
                ...
                <Button size="lg" variant="outline" asChild className="h-12 rounded-xl border-border bg-card px-6 font-semibold text-foreground hover:bg-muted">
