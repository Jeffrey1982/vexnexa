    ...
    >
      ...
      <div className="mb-4 flex items-center justify-between border-b border-slate-700/50 pb-3">
        <span className="text-[15px] font-bold tracking-wide text-white">
          Vex<span className="text-primary-400">Nexa</span>
        </span>
        <div className="flex items-center gap-2">
          <span className="relative flex h-2 w-2">
            <span className="hero-ping absolute inline-flex h-full w-full rounded-full bg-primary-400 opacity-75" />
            <span className="relative inline-flex h-2 w-2 rounded-full bg-primary-500" />
          </span>
          <span className="text-[11px] font-medium uppercase tracking-wider text-primary-400">{t("liveScan")}</span>
        </div>
      </div>
      ...
      <div className="mb-5">
        <div className="flex items-center justify-between mb-1.5">
          ...
          <span ref={pctRef} className="text-[11px] font-semibold text-primary-400">...%</span>
        </div>
        <div className="h-2 w-full rounded-full bg-zinc-800 overflow-hidden">
          <div className="hero-bar h-2 rounded-full bg-gradient-to-r from-primary-600 to-primary-400 origin-left" />
        </div>
      </div>
      ...
      <div className="mb-5 flex items-center gap-4 rounded-2xl bg-zinc-800/50 border border-slate-700/30 p-4">
        <div className="relative flex h-20 w-20 shrink-0 items-center justify-center">
          ...
          <span ref={scoreRef} className="absolute text-2xl font-bold tabular-nums text-primary-400">
            {SCORE_START}
          </span>
        </div>
        <div>
      ...
      <div className="hero-issues mb-4 space-y-2">
        ...
        <div className="flex items-center gap-3 rounded-xl border border-primary-500/20 bg-primary-500/10 px-3.5 py-2.5">
          <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-md bg-primary-500/20">
            <span className="text-[10px] font-bold text-primary-300">~</span>
          </div>
          <div className="min-w-0 flex-1">
            <p className="text-[12px] font-semibold text-primary-300 truncate">{t("lowContrast")}</p>
            <p className="text-[10px] text-primary-400/70">{t("moderateElements")}</p>
          </div>
        </div>
      </div>

      {/* White-label report — CSS-only delayed scale+fade */}
      <div className="hero-report rounded-2xl border border-primary-500/20 bg-gradient-to-br from-zinc-800/80 to-zinc-800/40 p-4">
        <div className="mb-3 flex items-center justify-between">
          ...
          <span className="rounded-full bg-primary-500/15 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-primary-400">
            {t("whiteLabel")}
          </span>
        </div>
        <div className="space-y-1.5">
          ...
          <div className="h-1.5 w-[70%] rounded-full bg-primary-500/20" />
        </div>
