...
export async function middleware(request: NextRequest) {
  ...
  const cspHeader = [
    ...
    "connect-src 'self' https://*.vexnexa.com https://vexnexa.com https://*.supabase.co https://va.vercel-scripts.com wss://*.supabase.co https://*.mollie.com https://www.google.com https://*.gstatic.com",
