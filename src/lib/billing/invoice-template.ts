...
<head>
  ...
  <style>
    ...
    .header { background: #2D5F3F; color: #fff; padding: 32px 40px; }
    ...
    .tax-note { font-size: 12px; color: #5A5A5A; margin-top: 16px; padding: 12px 16px; background: #F8F9FA; border-radius: 6px; border-left: 3px solid #2D5F3F; }
