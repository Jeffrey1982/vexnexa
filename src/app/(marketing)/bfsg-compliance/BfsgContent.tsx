...
import { ArrowRight, Activity, FileCheck2, ShieldCheck } from "lucide-react";

export function BfsgContent() {
  const t = useTranslations("bfsgPage");

  const capabilities = [
    { icon: Activity, title: t("capabilities.c1Title"), body: t("capabilities.c1Body") },
