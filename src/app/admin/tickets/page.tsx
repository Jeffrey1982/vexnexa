...
import { AdminTicketFiltersClient } from "./AdminTicketFiltersClient";
import { CreateTestTicketButton } from "./CreateTestTicketButton";
          ...
          actions={[
            {
              ...
              variant: "default",
              icon: Plus,
              onClick: () => {}, // Handled by CreateTestTicketButton
            },
            {
              label: "View Settings",
              variant: "outline",
