...
interface AdminInterfaceFiltersClientProps {
...
export function AdminInterfaceFiltersClient({
  hasActiveFilters,
  autoCollapse,
  currentStatus,
  currentPriority,
}: AdminInterfaceFiltersClientProps) {
  ...
  const updateFilter = (key: string, value: string) => {
    ...
    router.push(`/admin-interface${queryString ? `?${queryString}` : ''}`);
  };
