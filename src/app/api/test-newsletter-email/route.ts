    ...
    const baseEmailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          ...
          <div style="background: #F0FDFA; border: 2px solid #1F4A2D; padding: 16px; border-radius: 8px; margin: 20px 0;">
          ...
          <p style="color: #9CA3AF; font-size: 14px; text-align: center;">
            <strong>VexNexa</strong> | <a href="https://vexnexa.com" style="color: #1F4A2D;">vexnexa.com</a><br>
