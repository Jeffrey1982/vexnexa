    ...
    const baseEmailOptions = {
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <h2 style="color: #A0522D;">🧪 Email Headers & UTM Test</h2>
          ...
          <div style="text-align: center; margin: 32px 0;">
            ...
            <p>
              <a href="${dashboardUrl}" style="display: inline-block; background: #A0522D; color: white; padding: 12px 24px; border-radius: 6px; text-decoration: none; font-weight: 600; margin: 8px;">
