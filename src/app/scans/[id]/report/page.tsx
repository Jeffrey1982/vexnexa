    ...
    <>
      ...
      <div className="max-w-4xl mx-auto p-8 bg-white dark:bg-slate-950 min-h-screen">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground mb-1">{new URL(siteUrl).hostname}</p>
          ...
          <table className="print-table w-full">
            ...
            <tbody>
              <tr>
                ...
                <td className="text-center text-2xl font-bold text-muted-foreground">{stats.minor}</td>
              </tr>
            </tbody>
          </table>
        </div>
                ...
                <div key={index} className="mb-6 border border-gray-300 rounded p-4">
                  ...
                  {violation.nodes.length > 0 && (
                    <div>
                      ...
                      <ul className="list-disc list-inside text-xs font-mono text-muted-foreground ml-4">
        ...
        {/* Footer */}
        <div className="mt-12 pt-6 border-t border-gray-300 text-center text-sm text-muted-foreground">
